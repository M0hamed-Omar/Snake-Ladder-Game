...
void Card13::Save(ofstream& OutFile, ObjectType Obj)
{
	// Check Obj 
	if (Obj != CardObj)
		return;
...
void Card13::ResetFlag()
{
	Flag = false;
}

void Card13::resetStationOwner()
{
	CardOwner = NULL;
}
void Card13::SetFee(int f)
{
	Fee = f;
}
void Card13::SetCardPrice(int p)
{
	CardPrice = p;
}