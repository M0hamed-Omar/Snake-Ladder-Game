...
public:
	...
	//   7             C12  C13  ...  C22
	//   8             C1   C2   ...  C11
	// test to see in git ,,,, second test

	// In the Grid above, C13 has vCell = 7 and hCell = 1


	///TODO: IMPLEMENT THE FOLLOWING FUNCTION																				
	bool SetVCell(int v); // The setter of vCell (the setter here sets only if "v" is in grid range)  // Done.
...
///TODO: IMPLEMENT THE FOLLOWING FUNCTION																				
	...
	///TODO: IMPLEMENT THE FOLLOWING FUNCTION
	bool IsValidCell() const; // Checks if the current cell position (vCell and hCell) both are valid then return true            ***mo
	// Otherwise, return false

	int GetCellNum() const;   // Gets the cellNum from the vCell and hCell of the cell position

	///TODO: IMPLEMENT THE FOLLOWING FUNCTION 
	static int GetCellNumFromPosition(const CellPosition& cellPosition);  // Calculates the cellNum of the passed "cellPosition"        ***mo
	// It is a static function (no need for a calling obj)

///TODO: IMPLEMENT THE FOLLOWING FUNCTION
	static CellPosition GetCellPositionFromNum(int cellNum); // Returns the corresponding CellPosition (vCell, hCell) of the passed cellNum      ***K
	// It is a static function (no need for a calling obj)

///TODO: IMPLEMENT THE FOLLOWING FUNCTION
	void AddCellNum(int addedNum); // Adds the passed "addedNum" to the "cellNum" of the current cell position					***K => **i took it**
