...
public:
	...
	int GetInteger(Output* pO) const;    // Returns an integer entered by the user             ******K

	// ========== Game Functions ==========

	///TODO: COMPLETE THE IMPLEMENTATIN OF THE FOLLOWING FUNCTION
	ActionType GetUserAction() const;	 // Reads a user click and map it to its corresponding ActionType			**K

	///TODO: COMPLETE THE IMPLEMENTATIN OF THE FOLLOWING FUNCTION						 Done *****by Md7t 
