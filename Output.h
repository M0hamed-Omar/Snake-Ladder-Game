...
private:
	...
	// of the upper left corner of the passed cellpos         ****K

///TODO: IMPLEMENT THE FOLLOWING FUNCTION
	int GetCellStartY(const CellPosition& cellpos) const;	// Gets the Y coordinate 
	// of the upper left corner of the passed cellpos      *****K

///TODO: COMPLETE THE IMPLEMENTATIN OF THE FOLLOWING FUNCTION													*****K
...
public:
	...
	void CreateDesignModeToolBar() const;	// Creates the Design mode toolbar with all its menu icons    *******K  /////done

	///TODO: COMPLETE THE IMPLEMENTATIN OF THE FOLLOWING FUNCTION
	void CreatePlayModeToolBar() const;		// Creates the Play mode toolbar with all its menu icons          ******MO ///////done

	void PrintMessage(string msg) const;	// Prints a message on Status bar

	///TODO: COMPLETE THE IMPLEMENTATIN OF THE FOLLOWING FUNCTION													*******Md7t
	void PrintPlayersInfo(string info);		// Prints players' info on the right-side of the toolbar

	// ========== Game Drawing Functions ==========

	///TODO: COMPLETE THE IMPLEMENTATIN OF THE FOLLOWING FUNCTION	
	void DrawCell(const CellPosition& cellpos, int cardNum = -1) const;												//*****MD7t
...
///TODO: COMPLETE THE IMPLEMENTATIN OF THE FOLLOWING FUNCTION	
	void DrawSnake(const CellPosition& fromCellPos, const CellPosition& toCellPos) const;				//*****MO//done
